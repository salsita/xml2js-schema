describe("Schema-driven XML to JS object generation", function() {
  ...
  beforeEach(function() {
    ...
    var xml2js = require("../../../frameworks/xml2js");
    var xml2js_schema = require("../../../frameworks/xml2js-schema");
    parser = new xml2js.Parser({ validator: new xml2js_schema.Validator(schema) });
